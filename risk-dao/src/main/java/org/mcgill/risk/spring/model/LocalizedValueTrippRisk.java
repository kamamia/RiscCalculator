...
*/
@Entity
@Table(name = "(select * from LOCALIZED_VALUE where BUSINESS_ID in ('2','4','5','7','9','13','16','17','18') ) ")
public class LocalizedValueTrippRisk {
	...
	public boolean equals(Object obj) {
		...
		if (obj == null)
			return false;
		if (!(obj instanceof LocalizedValueTrippRisk))
			return false;
		LocalizedValueTrippRisk other = (LocalizedValueTrippRisk) obj;
	...
	public String toString() {
		return "LocalizedValueTrippRisk Drug [this.businessId->"
				+ this.businessId + "<- id=" + id + ", descriptionEn="
				+ this.descriptionEn +
